...
const ReleaseUrl = "https://api.github.com/repos/HvTcCore/VencordFrk/releases/latest"
const ReleaseUrlFallback = "https://vencord.dev/releases/vencord"
const InstallerReleaseUrl = "https://api.github.com/repos/HvTcCore/Installer/releases/latest"
